...
<div class="top-form top-form-minicart topdeal-minicart pull-right">
	<div class="top-minicart-icon pull-right">
		...
		<div class="cart-right">
			...
			<p><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count. esc_html__(' Item(s) ','topdeal'). '</span>';?><span class="icon-plus">-</span><?php echo $woocommerce->cart->get_cart_total(); ?></p>
		</div>
	</div>
