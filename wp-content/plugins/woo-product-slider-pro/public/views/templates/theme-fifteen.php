...
if ( has_post_thumbnail() && $product_image == 'true' || $product_image == 'true' && $placeholder_image ) {
	...
	if ( class_exists( 'SP_Woo_Quick_View_Pro' ) && $quick_view == 'true' ) {
		...
		$outline .= '<a href="#" class="button sp-wqv-view-button sp-wpsp-wqv-button" data-id="' . esc_attr( get_the_ID() ) . '" data-effect="' . sp_wqv_get_option( 'wqv_popup_effect' ) . '" data-wqv=\'{"close_button": "' . $close_button . '" } \'></a>';
		...
		$outline .= '<a href="#" class="yith-wcqv-button sp-wpsp-wqv-button" data-product_id="' . $product_id . '">' . $label . '</a>';
	}
