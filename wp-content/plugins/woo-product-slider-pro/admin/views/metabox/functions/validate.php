...
if ( ! function_exists( 'sp_validate_email' ) ) {
	function sp_validate_email( $value, $field ) {
		...
		if ( ! sanitize_email( $value ) ) {
			return __( 'Please write a valid email address!', 'woo-product-slider-pro' );
		}
...
if ( ! function_exists( 'sp_validate_numeric' ) ) {
	function sp_validate_numeric( $value, $field ) {
		...
		if ( ! is_numeric( $value ) ) {
			return __( 'Please write a numeric data!', 'woo-product-slider-pro' );
		}
...
if ( ! function_exists( 'sp_validate_required' ) ) {
	function sp_validate_required( $value ) {
		if ( empty( $value ) ) {
			return __( 'Fatal Error! This field is required!', 'woo-product-slider-pro' );
		}
	}
