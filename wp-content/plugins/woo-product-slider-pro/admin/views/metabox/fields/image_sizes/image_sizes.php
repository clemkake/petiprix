 ...
 */
class SP_WPSP_Framework_Option_image_sizes extends SP_WPSP_Framework_Options {
	/**
	 * Field: Image Sizes
	 *
	...
	public function output() {
		...
		foreach ( get_intermediate_image_sizes() as $_size ) {
			...
			$sizes = array_merge(
				$sizes, array(
					'full'   => __( 'original uploaded image', 'woo-product-slider-pro' ),
					'custom' => __( 'set custom size', 'woo-product-slider-pro' ),
				)
			);
